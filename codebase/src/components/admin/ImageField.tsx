...
/**
 * Cover image picker. Uploads to Cloudinary via l'API Express when configured;
 * otherwise the client can still paste a URL, so the admin stays usable without keys.
 */
export default function ImageField({
  ...
  id?: string;
  hint?: string;
  /** Dossier Cloudinary cible (voir ALLOWED_FOLDERS côté serveur). */
  folder?: string;
}) {
